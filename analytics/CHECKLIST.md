...
Reproduzir: `cd backend && python3 -m pytest -q` (236 testes, sem rede).
...
| 18 | Possuir testes automatizados | ✅ | 236 testes, ~34 s, sem rede: unitários, banco, API e integração. ⚠️ Faltam testes de interface (não há frontend ainda). |
